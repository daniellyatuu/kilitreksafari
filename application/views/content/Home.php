                ...
                <ul>
                    <li data-transition="fade" data-slotamount="default"  data-easein="easeInOut" data-easeout="easeInOut" data-masterspeed="2000" data-rotate="0" data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7">
                        ...
                        <div class="tp-caption Agency-SmallTitle tp-resizeme rs-parallaxlevel-3" id="slide-1-layer-3" 
                            ...
                            data-splitout="none" 
                            data-responsive_offset="on"
                            style="z-index: 8; letter-spacing: 0px; font-family: 'Libre Baskerville', serif;">I want to make memories all
                        </div>
                        ...
                        <div class="tp-caption Agency-SmallTitle tp-resizeme rs-parallaxlevel-3" id="slide-1-layer-4" 
                            ...
                            data-splitout="none" 
                            data-responsive_offset="on"
                            style="z-index: 8; letter-spacing: 0px; font-family: 'Libre Baskerville', serif;">over the world.
                        </div>
                    </li>
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-xs-6 counter-box">
                    <div class="counter-details">
                        <i><img src="<?=base_url('assets/images/counter-icon1.png'); ?>" alt="Counter" /></i>
                        <h3><span class="count" id="statistics_count-1" data-statistics_percent="100"> &nbsp;</span></h3>
                        <p>Photographs</p>
                    </div>
                </div><!-- Counter Box /- -->
                <!-- Counter Box -->
                <div class="col-md-3 col-sm-6 col-xs-6 counter-box">
                    <div class="counter-details">
                        <i><img src="<?=base_url('assets/images/counter-icon2.png'); ?>" alt="Counter" /></i>
                        <h3><span class="count" id="statistics_count-2" data-statistics_percent="3"> &nbsp;</span></h3>
                        <p>Destination</p>
                    </div>
                </div><!-- Counter Box /- -->
                <!-- Counter Box -->
                <div class="col-md-3 col-sm-6 col-xs-6 counter-box">
                    <div class="counter-details">
                        <i><img src="<?=base_url('assets/images/counter-icon4.png'); ?>" alt="Counter" /></i>
                        <h3><span class="count" id="statistics_count-3" data-statistics_percent="34"> &nbsp;</span></h3>
                        <p>Tour guide</p>
                    </div>
                </div><!-- Counter Box /- -->
                <!-- Counter Box -->
